...
def getTargetsFromIdVd():
    ...
    """
    print("Working on Ids_Vds_Vgs curves.")
    srcdir = r"C:\\Users\\shuancai\\Desktop\\MQA_test\\Python_Test\\IV_Sweeps"
    prjs = loadmqaresult(srcdir)
    r = prjs[0]
...
def getGdsFromIdVd():
    ...
    5. Gds2: second order derivative of IdVd
    """
    print("Now working on Ids_Vds_Vgs Derivatives.")
    srcdir = r"C:\\Users\\shuancai\\Desktop\\MQA_test\\Python_Test\\IV_Sweeps"
    prjs = loadmqaresult(srcdir)
    r = prjs[0]
    ids = r.searchtag("Ids", ruleid="5002")
...
def getSubthresholdSwing():
    ...
    """
    # need to be able to calculate Vth for each IdVg curve, then find the slope of that curve.
...
if __name__ == "__main__":
    ...
    print("Total time:", round((t2 - t1), 2))
